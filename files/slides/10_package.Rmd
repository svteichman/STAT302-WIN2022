...
Since the `%>%` operator is special, the best for you to make sure that anyone installing your package will be able to use it is to set your working directory to the package directory and run the line `usethis::use_pipe()`.
